...
hotcrossedbuns = ["E3", "0", "D3", "0", "C3", "0", "S", "E3", "0", "D3", "0", "C3", "0", "S", "C3", "C3", "C3", "C3", "D3", "D3", "D3", "D3", "S", "E3", "0", "D3", "0", "C3", "0", "E3", "0", "D3", "0", "C3", "0", "S", "E3", "0", "D3", "0", "C3", "0", "S", "C3", "C3", "C3", "C3", "D3", "D3", "D3", "D3", "S", "E3", "0", "D3", "0", "C3", "0"]
...
def playnote(Note, Duration):
    ...
    if Note == "S":
        ...
        speaker2.duty_u16(10000)
        
        speaker.freq(MusicNotes[Note])
        speaker2.freq(MusicNotes[Note])
        sleep(Duration)
